 ...
 * @link     https://github.com/afrikpaysas/symfony-thirdparty-adapter/blob/master/Lib/Exception/EmailApiDisabled.php
 *
        ...
        parent::__construct(
            [
                AppConstants::CODE => sprintf(
                    SystemExceptionMessage::EMAIL_API_DISABLED[
                        AppConstants::CODE
                    ],
                    $_ENV['APP_CODE']
                ),
                AppConstants::MESSAGE => SystemExceptionMessage::EMAIL_API_DISABLED[
